...
st.title('Sollecito Tavoli e Sedie')
...
layout = {
    'output' : ['Materiale','Descrizione doc.','UM','Quantità','Numero',
                ...
                'Modello piano tavolo','Colore superficie tavolo','Colore bordo tavolo',
                'Estetica fondino sedia','Materiale fondino sedia','Colore fondino sedia',
                'Materiale struttura sedia','Colore struttura sedia','Colore schienale sedia'
                ]
}
...
try:
    zsd67 = zsd67.rename(columns={'C_MODPTAV-Modello Piano Tavolo':'Modello piano tavolo'})
except:
    pass
#----------------------
try:
    zsd67 = zsd67.rename(columns={'C_COLSUP1TAV-Colore Superficie 1 tavolo':'Colore superficie tavolo'})
except:
    pass
#----------------------
try:
    zsd67 = zsd67.rename(columns={'C_COLBORPTAV-Colore Bordo Tavolo':'Colore bordo tavolo'})
except:
    pass
#----------------------
try:
    zsd67 = zsd67.rename(columns={'C_ESTFONDINO-Estetica fondino':'Estetica fondino sedia'})
except:
    pass
#----------------------
try:
    zsd67 = zsd67.rename(columns={'C_MATFONDSEDIA-Materiale fondino sedia':'Materiale fondino sedia'})
except:
    pass
#----------------------
try:
    zsd67 = zsd67.rename(columns={'C_COLFONDSEDIA-Colore fondino sedia':'Colore fondino sedia'})
except:
    pass
#----------------------
try:
    zsd67 = zsd67.rename(columns={'C_MATSTRUSEDIA-Materiale struttura sedia':'Materiale struttura sedia'})
except:
    pass
#----------------------
try:
    zsd67 = zsd67.rename(columns={'C_COLSTRUSEDIA-Colore struttura sedia':'Colore struttura sedia'})
except:
    pass
#----------------------
try:
    zsd67 = zsd67.rename(columns={'C_COLSCHIENSEDIA-Colore schienale sedia':'Colore schienale sedia'})
except:
    pass
#----------------------
